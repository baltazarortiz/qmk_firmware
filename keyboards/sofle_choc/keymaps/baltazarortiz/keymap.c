 ...
 * `---------------------------------------------/       /     \      \---------------------------------------------'
 *                | LGUI | LAlt | LCTR |SPC   | / RAISE /       \LOWER \  |SPC   | RCTL | RAlt | RGUI |
 *                |      |      | TAB  |      |/       /         \      \ |      | TAB  |      |      |
 *                 `----------------------------------'           '------''---------------------------'
 */
...
[_COLEMAK] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,       KC_MPLY,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT, \
              KC_LGUI,KC_LALT,LCTL_T(KC_TAB),KC_SPC, OSL(_RAISE),      OSL(_LOWER),  KC_SPC, RCTL_T(KC_TAB), KC_RALT, KC_RGUI \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_EXLM,   KC_AT, KC_LBRC,  KC_RBRC, KC_PERC,                       KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_SCLN, KC_PIPE, \
  _______,  KC_PLUS, KC_EQL, KC_MINS, KC_BSPC, KC_RCBR, _______,       _______, KC_COLN, KC_BSPC, KC_ASTR, KC_COLN, KC_BSLS, _______, \
                       _______, _______, _______, KC_ENT, MO(_ADJUST),    _______, KC_ENT, _______, _______, _______\
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 * |REBOOT|      |      |      |      |RGBTog|                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | BOOT | Spd+ | Val+ | Sat+ | Hue+ |Mode+ |                    |      | MUTE | PLAY |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      | Spd- | Val- | Sat- | Hue- |Mode- |-------.    ,-------| PREV | VOLDO| VOLUP| NEXT |      |      |
 * |------+------+------+------+------+------|       |    |       |------+------+------+------+------+------|
 * |MacWin|      |      |      |      |      |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |ENTER | /RAISE  /       \LOWER \  |ENTER | RCTR | RAlt | RGUI |
 ...
 */
[_ADJUST] = LAYOUT(
    QK_REBOOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_TOG,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    QK_BOOT, RGB_SPI, RGB_VAI, RGB_SAI, RGB_HUI, RGB_MODE_FORWARD,                       XXXXXXX, KC_MUTE, KC_MPLY, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, RGB_SPD, RGB_VAD, RGB_SAD, RGB_HUD, RGB_MODE_REVERSE,                       KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, XXXXXXX, XXXXXXX,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_COLEMAK] = { ENCODER_CCW_CW(KC_PGUP, KC_PGDN),   ENCODER_CCW_CW(KC_VOLD, KC_VOLU)  },
